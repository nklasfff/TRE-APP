...
// Complete tour sequence - more logical flow
const tourSequence = [
    // Start with TRE center
    { type: 'circle', id: 'tre', duration: 4000 },
    
    // Go around the circle clockwise, showing each perspective and key connections
    // Polyvagal
    ...
    { type: 'connection', from: 'tre', to: 'narrative', duration: 2000 },
    
    // Enactivisme
    { type: 'connection', from: 'narrative', to: 'enactivisme', duration: 2500 },
    { type: 'circle', id: 'enactivisme', duration: 3500 },
    { type: 'connection', from: 'tre', to: 'enactivisme', duration: 2000 },
    
    // Levine
    { type: 'connection', from: 'enactivisme', to: 'levine', duration: 2500 },
    { type: 'circle', id: 'levine', duration: 3500 },
    { type: 'connection', from: 'tre', to: 'levine', duration: 2000 },
    
    // Reich
    { type: 'connection', from: 'levine', to: 'reich', duration: 2500 },
    { type: 'circle', id: 'reich', duration: 3500 },
    { type: 'connection', from: 'tre', to: 'reich', duration: 2000 },
    
    // Psykologi
    { type: 'connection', from: 'reich', to: 'psykologi', duration: 2500 },
    { type: 'circle', id: 'psykologi', duration: 3500 },
    { type: 'connection', from: 'tre', to: 'psykologi', duration: 2000 },
    { type: 'connection', from: 'psykologi', to: 'polyvagal', duration: 2500 },
    
    // Now show some key cross-connections
    { type: 'connection', from: 'polyvagal', to: 'narrative', duration: 2000 },
    { type: 'connection', from: 'polyvagal', to: 'levine', duration: 2000 },
    { type: 'connection', from: 'polyvagal', to: 'reich', duration: 2000 },
    
    { type: 'connection', from: 'narrative', to: 'enactivisme', duration: 2000 },
    { type: 'connection', from: 'narrative', to: 'levine', duration: 2000 },
    { type: 'connection', from: 'narrative', to: 'psykologi', duration: 2000 },
    
    { type: 'connection', from: 'enactivisme', to: 'levine', duration: 2000 },
    { type: 'connection', from: 'enactivisme', to: 'reich', duration: 2000 },
    { type: 'connection', from: 'enactivisme', to: 'psykologi', duration: 2000 },
    
    { type: 'connection', from: 'levine', to: 'reich', duration: 2000 },
    { type: 'connection', from: 'levine', to: 'psykologi', duration: 2000 },
    
    { type: 'connection', from: 'reich', to: 'psykologi', duration: 2000 },
    
    // Show some of the longer cross-connections
    { type: 'connection', from: 'polyvagal', to: 'enactivisme', duration: 2000 },
    { type: 'connection', from: 'narrative', to: 'reich', duration: 2000 },
    { type: 'connection', from: 'enactivisme', to: 'psykologi', duration: 2000 },
    { type: 'connection', from: 'polyvagal', to: 'psykologi', duration: 2000 }
];
